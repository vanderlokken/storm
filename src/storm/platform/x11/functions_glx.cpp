...
FunctionAddress getFunctionAddress( const char *functionName ) {
    return ::glXGetProcAddress( reinterpret_cast<const GLubyte*>(functionName) );
}

#define DECLARE( functionName ) \
    static const Pointer pointer = \
        reinterpret_cast< Pointer >( getFunctionAddress(functionName) ); \
    if( !pointer ) storm::throwRuntimeError( "Function is unavailable" );

void glCullFace( GLenum mode ) {
    typedef void (*Pointer)( GLenum );
    DECLARE( "glCullFace" );
    return pointer( mode );
}
...
void glHint( GLenum target, GLenum mode ) {
    typedef void (*Pointer)( GLenum, GLenum );
    DECLARE( "glHint" );
    return pointer( target, mode );
}

void glLineWidth( GLfloat width ) {
    typedef void (*Pointer)( GLfloat );
    DECLARE( "glLineWidth" );
...
void glScissor( GLint x, GLint y, GLsizei width, GLsizei height ) {
    typedef void (*Pointer)( GLint, GLint, GLsizei, GLsizei );
    DECLARE( "glScissor" );
    return pointer( x, y, width, height );
}

void glTexParameterf( GLenum target, GLenum pname, GLfloat param ) {
    typedef void (*Pointer)( GLenum, GLenum, GLfloat );
    DECLARE( "glTexParameterf" );
    return pointer( target, pname, param );
}

void glTexParameterfv( GLenum target, GLenum pname, const GLfloat *params ) {
    typedef void (*Pointer)( GLenum, GLenum, const GLfloat* );
    DECLARE( "glTexParameterfv" );
    return pointer( target, pname, params );
}

void glTexParameteri( GLenum target, GLenum pname, GLint param ) {
    typedef void (*Pointer)( GLenum, GLenum, GLint );
    DECLARE( "glTexParameteri" );
    return pointer( target, pname, param );
}

void glTexParameteriv( GLenum target, GLenum pname, const GLint *params ) {
    typedef void (*Pointer)( GLenum, GLenum, const GLint* );
    DECLARE( "glTexParameteriv" );
    return pointer( target, pname, params );
}

void glTexImage1D( GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels ) {
    typedef void (*Pointer)( GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, const GLvoid* );
...
void glTexImage2D( GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels ) {
    typedef void (*Pointer)( GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid* );
...
void glClear( GLbitfield mask ) {
    typedef void (*Pointer)( GLbitfield );
    DECLARE( "glClear" );
    return pointer( mask );
}

void glClearColor( GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha ) {
    typedef void (*Pointer)( GLclampf, GLclampf, GLclampf, GLclampf );
    DECLARE( "glClearColor" );
    return pointer( red, green, blue, alpha );
}

void glClearStencil( GLint s ) {
    typedef void (*Pointer)( GLint );
    DECLARE( "glClearStencil" );
    return pointer( s );
}

void glClearDepth( GLclampd depth ) {
    typedef void (*Pointer)( GLclampd );
    DECLARE( "glClearDepth" );
    return pointer( depth );
}

void glStencilMask( GLuint mask ) {
    typedef void (*Pointer)( GLuint );
    DECLARE( "glStencilMask" );
    return pointer( mask );
}

void glColorMask( GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha ) {
    typedef void (*Pointer)( GLboolean, GLboolean, GLboolean, GLboolean );
    DECLARE( "glColorMask" );
    return pointer( red, green, blue, alpha );
}

void glDepthMask( GLboolean flag ) {
    typedef void (*Pointer)( GLboolean );
    DECLARE( "glDepthMask" );
    return pointer( flag );
}
...
void glStencilFunc( GLenum func, GLint ref, GLuint mask ) {
    typedef void (*Pointer)( GLenum, GLint, GLuint );
    DECLARE( "glStencilFunc" );
    return pointer( func, ref, mask );
}

void glStencilOp( GLenum fail, GLenum zfail, GLenum zpass ) {
    typedef void (*Pointer)( GLenum, GLenum, GLenum );
    DECLARE( "glStencilOp" );
...
void glPixelStoref( GLenum pname, GLfloat param ) {
    typedef void (*Pointer)( GLenum, GLfloat );
    DECLARE( "glPixelStoref" );
    return pointer( pname, param );
}

void glPixelStorei( GLenum pname, GLint param ) {
    typedef void (*Pointer)( GLenum, GLint );
...
void glReadPixels( GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels ) {
    typedef void (*Pointer)( GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLvoid* );
    DECLARE( "glReadPixels" );
    return pointer( x, y, width, height, format, type, pixels );
}

void glGetBooleanv( GLenum pname, GLboolean *params ) {
    typedef void (*Pointer)( GLenum, GLboolean* );
    DECLARE( "glGetBooleanv" );
    return pointer( pname, params );
}

void glGetDoublev( GLenum pname, GLdouble *params ) {
    typedef void (*Pointer)( GLenum, GLdouble* );
    DECLARE( "glGetDoublev" );
    return pointer( pname, params );
}

GLenum glGetError( void ) {
    typedef GLenum (*Pointer)( void );
    DECLARE( "glGetError" );
    return pointer( );
}
...
const GLubyte* glGetString( GLenum name ) {
    typedef const GLubyte* (*Pointer)( GLenum );
    DECLARE( "GLubyte * glGetString" );
    return pointer( name );
}

void glGetTexImage( GLenum target, GLint level, GLenum format, GLenum type, GLvoid *pixels ) {
    typedef void (*Pointer)( GLenum, GLint, GLenum, GLenum, GLvoid* );
...
void glDrawRangeElements( GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices ) {
    typedef void (*Pointer)( GLenum, GLuint, GLuint, GLsizei, GLenum, const GLvoid* );
    DECLARE( "glDrawRangeElements" );
    return pointer( mode, start, end, count, type, indices );
}

void glTexImage3D( GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *pixels ) {
    typedef void (*Pointer)( GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid* );
...
void glTexSubImage3D( GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels ) {
    typedef void (*Pointer)( GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const GLvoid* );
...
void glCopyTexSubImage3D( GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height ) {
    typedef void (*Pointer)( GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei );
...
void glSampleCoverage( GLclampf value, GLboolean invert ) {
    typedef void (*Pointer)( GLclampf, GLboolean );
    DECLARE( "glSampleCoverage" );
    return pointer( value, invert );
}

void glCompressedTexImage3D( GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid *data ) {
    typedef void (*Pointer)( GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const GLvoid* );
...
void glCompressedTexImage2D( GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *data ) {
    typedef void (*Pointer)( GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const GLvoid* );
...
void glCompressedTexImage1D( GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid *data ) {
    typedef void (*Pointer)( GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, const GLvoid* );
...
void glCompressedTexSubImage3D( GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid *data ) {
    typedef void (*Pointer)( GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid* );
...
void glCompressedTexSubImage2D( GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *data ) {
    typedef void (*Pointer)( GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid* );
...
void glPointParameterfv( GLenum pname, const GLfloat *params ) {
    typedef void (*Pointer)( GLenum, const GLfloat* );
...
void glPointParameteriv( GLenum pname, const GLint *params ) {
    typedef void (*Pointer)( GLenum, const GLint* );
...
void glGetQueryObjectiv( GLuint id, GLenum pname, GLint *params ) {
    typedef void (*Pointer)( GLuint, GLenum, GLint* );
    DECLARE( "glGetQueryObjectiv" );
    return pointer( id, pname, params );
}

void glGetQueryObjectuiv( GLuint id, GLenum pname, GLuint *params ) {
    typedef void (*Pointer)( GLuint, GLenum, GLuint* );
...
void glBufferData( GLenum target, GLsizeiptr size, const GLvoid *data, GLenum usage ) {
    typedef void (*Pointer)( GLenum, GLsizeiptr, const GLvoid*, GLenum );
    DECLARE( "glBufferData" );
    return pointer( target, size, data, usage );
}

void glBufferSubData( GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid *data ) {
    typedef void (*Pointer)( GLenum, GLintptr, GLsizeiptr, const GLvoid* );
    DECLARE( "glBufferSubData" );
    return pointer( target, offset, size, data );
}

void glGetBufferSubData( GLenum target, GLintptr offset, GLsizeiptr size, GLvoid *data ) {
    typedef void (*Pointer)( GLenum, GLintptr, GLsizeiptr, GLvoid* );
    DECLARE( "glGetBufferSubData" );
    return pointer( target, offset, size, data );
}

GLvoid* glMapBuffer( GLenum target, GLenum access ) {
    typedef GLvoid* (*Pointer)( GLenum, GLenum );
    DECLARE( "glMapBuffer" );
...
void glGetBufferPointerv( GLenum target, GLenum pname, GLvoid* *params ) {
    typedef void (*Pointer)( GLenum, GLenum, GLvoid** );
...
void glDrawBuffers( GLsizei n, const GLenum *bufs ) {
    typedef void (*Pointer)( GLsizei, const GLenum* );
...
void glStencilFuncSeparate( GLenum frontfunc, GLenum backfunc, GLint ref, GLuint mask ) {
    typedef void (*Pointer)( GLenum, GLenum, GLint, GLuint );
...
void glAttachShader( GLuint program, GLuint shader ) {
    typedef void (*Pointer)( GLuint, GLuint );
    DECLARE( "glAttachShader" );
    return pointer( program, shader );
}

void glBindAttribLocation( GLuint program, GLuint index, const GLchar *name ) {
    typedef void (*Pointer)( GLuint, GLuint, const GLchar* );
...
GLuint glCreateProgram( void ) {
    typedef GLuint (*Pointer)( void );
    DECLARE( "glCreateProgram" );
    return pointer( );
}

GLuint glCreateShader( GLenum type ) {
    typedef GLuint (*Pointer)( GLenum );
...
void glGetActiveAttrib( GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLint *size, GLenum *type, GLchar *name ) {
    typedef void (*Pointer)( GLuint, GLuint, GLsizei, GLsizei*, GLint*, GLenum*, GLchar* );
...
void glGetAttachedShaders( GLuint program, GLsizei maxCount, GLsizei *count, GLuint *obj ) {
    typedef void (*Pointer)( GLuint, GLsizei, GLsizei*, GLuint* );
    DECLARE( "glGetAttachedShaders" );
    return pointer( program, maxCount, count, obj );
}

GLint glGetAttribLocation( GLuint program, const GLchar *name ) {
    typedef GLint (*Pointer)( GLuint, const GLchar* );
...
void glGetProgramInfoLog( GLuint program, GLsizei bufSize, GLsizei *length, GLchar *infoLog ) {
    typedef void (*Pointer)( GLuint, GLsizei, GLsizei*, GLchar* );
...
void glGetVertexAttribPointerv( GLuint index, GLenum pname, GLvoid* *ptr ) {
    typedef void (*Pointer)( GLuint, GLenum, GLvoid** );
...
void glShaderSource( GLuint shader, GLsizei count, const GLchar* *string, const GLint *length ) {
    typedef void (*Pointer)( GLuint, GLsizei, const GLchar**, const GLint* );
...
void glUniform1f( GLint location, GLfloat v0 ) {
    typedef void (*Pointer)( GLint, GLfloat );
    DECLARE( "glUniform1f" );
    return pointer( location, v0 );
}

void glUniform2f( GLint location, GLfloat v0, GLfloat v1 ) {
    typedef void (*Pointer)( GLint, GLfloat, GLfloat );
    DECLARE( "glUniform2f" );
    return pointer( location, v0, v1 );
}

void glUniform3f( GLint location, GLfloat v0, GLfloat v1, GLfloat v2 ) {
    typedef void (*Pointer)( GLint, GLfloat, GLfloat, GLfloat );
    DECLARE( "glUniform3f" );
    return pointer( location, v0, v1, v2 );
}

void glUniform4f( GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3 ) {
    typedef void (*Pointer)( GLint, GLfloat, GLfloat, GLfloat, GLfloat );
    DECLARE( "glUniform4f" );
    return pointer( location, v0, v1, v2, v3 );
}

void glUniform1i( GLint location, GLint v0 ) {
    typedef void (*Pointer)( GLint, GLint );
    DECLARE( "glUniform1i" );
    return pointer( location, v0 );
}

void glUniform2i( GLint location, GLint v0, GLint v1 ) {
    typedef void (*Pointer)( GLint, GLint, GLint );
    DECLARE( "glUniform2i" );
    return pointer( location, v0, v1 );
}

void glUniform3i( GLint location, GLint v0, GLint v1, GLint v2 ) {
    typedef void (*Pointer)( GLint, GLint, GLint, GLint );
    DECLARE( "glUniform3i" );
    return pointer( location, v0, v1, v2 );
}

void glUniform4i( GLint location, GLint v0, GLint v1, GLint v2, GLint v3 ) {
    typedef void (*Pointer)( GLint, GLint, GLint, GLint, GLint );
    DECLARE( "glUniform4i" );
    return pointer( location, v0, v1, v2, v3 );
}

void glUniform1fv( GLint location, GLsizei count, const GLfloat *value ) {
    typedef void (*Pointer)( GLint, GLsizei, const GLfloat* );
...
void glUniform1iv( GLint location, GLsizei count, const GLint *value ) {
    typedef void (*Pointer)( GLint, GLsizei, const GLint* );
...
void glUniformMatrix2fv( GLint location, GLsizei count, GLboolean transpose, const GLfloat *value ) {
    typedef void (*Pointer)( GLint, GLsizei, GLboolean, const GLfloat* );
...
void glVertexAttrib1d( GLuint index, GLdouble x ) {
    typedef void (*Pointer)( GLuint, GLdouble );
    DECLARE( "glVertexAttrib1d" );
    return pointer( index, x );
}

void glVertexAttrib1dv( GLuint index, const GLdouble *v ) {
    typedef void (*Pointer)( GLuint, const GLdouble* );
    DECLARE( "glVertexAttrib1dv" );
    return pointer( index, v );
}

void glVertexAttrib1f( GLuint index, GLfloat x ) {
    typedef void (*Pointer)( GLuint, GLfloat );
    DECLARE( "glVertexAttrib1f" );
    return pointer( index, x );
}

void glVertexAttrib1fv( GLuint index, const GLfloat *v ) {
    typedef void (*Pointer)( GLuint, const GLfloat* );
    DECLARE( "glVertexAttrib1fv" );
    return pointer( index, v );
}

void glVertexAttrib1s( GLuint index, GLshort x ) {
    typedef void (*Pointer)( GLuint, GLshort );
    DECLARE( "glVertexAttrib1s" );
    return pointer( index, x );
}

void glVertexAttrib1sv( GLuint index, const GLshort *v ) {
    typedef void (*Pointer)( GLuint, const GLshort* );
    DECLARE( "glVertexAttrib1sv" );
    return pointer( index, v );
}

void glVertexAttrib2d( GLuint index, GLdouble x, GLdouble y ) {
    typedef void (*Pointer)( GLuint, GLdouble, GLdouble );
...
void glVertexAttrib2f( GLuint index, GLfloat x, GLfloat y ) {
    typedef void (*Pointer)( GLuint, GLfloat, GLfloat );
...
void glVertexAttrib2s( GLuint index, GLshort x, GLshort y ) {
    typedef void (*Pointer)( GLuint, GLshort, GLshort );
...
void glVertexAttrib3d( GLuint index, GLdouble x, GLdouble y, GLdouble z ) {
    typedef void (*Pointer)( GLuint, GLdouble, GLdouble, GLdouble );
...
void glVertexAttrib3f( GLuint index, GLfloat x, GLfloat y, GLfloat z ) {
    typedef void (*Pointer)( GLuint, GLfloat, GLfloat, GLfloat );
...
void glVertexAttrib3s( GLuint index, GLshort x, GLshort y, GLshort z ) {
    typedef void (*Pointer)( GLuint, GLshort, GLshort, GLshort );
...
void glVertexAttrib4Nbv( GLuint index, const GLbyte *v ) {
    typedef void (*Pointer)( GLuint, const GLbyte* );
    DECLARE( "glVertexAttrib4Nbv" );
    return pointer( index, v );
}

void glVertexAttrib4Niv( GLuint index, const GLint *v ) {
    typedef void (*Pointer)( GLuint, const GLint* );
...
void glVertexAttrib4Nub( GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w ) {
    typedef void (*Pointer)( GLuint, GLubyte, GLubyte, GLubyte, GLubyte );
    DECLARE( "glVertexAttrib4Nub" );
    return pointer( index, x, y, z, w );
}

void glVertexAttrib4Nubv( GLuint index, const GLubyte *v ) {
    typedef void (*Pointer)( GLuint, const GLubyte* );
    DECLARE( "glVertexAttrib4Nubv" );
    return pointer( index, v );
}

void glVertexAttrib4Nuiv( GLuint index, const GLuint *v ) {
    typedef void (*Pointer)( GLuint, const GLuint* );
    DECLARE( "glVertexAttrib4Nuiv" );
    return pointer( index, v );
}

void glVertexAttrib4Nusv( GLuint index, const GLushort *v ) {
    typedef void (*Pointer)( GLuint, const GLushort* );
...
void glVertexAttrib4d( GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w ) {
    typedef void (*Pointer)( GLuint, GLdouble, GLdouble, GLdouble, GLdouble );
...
void glVertexAttrib4f( GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w ) {
    typedef void (*Pointer)( GLuint, GLfloat, GLfloat, GLfloat, GLfloat );
...
void glVertexAttrib4s( GLuint index, GLshort x, GLshort y, GLshort z, GLshort w ) {
    typedef void (*Pointer)( GLuint, GLshort, GLshort, GLshort, GLshort );
...
void glVertexAttribPointer( GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid *ptr ) {
    typedef void (*Pointer)( GLuint, GLint, GLenum, GLboolean, GLsizei, const GLvoid* );
...
void glColorMaski( GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a ) {
    typedef void (*Pointer)( GLuint, GLboolean, GLboolean, GLboolean, GLboolean );
    DECLARE( "glColorMaski" );
    return pointer( index, r, g, b, a );
}

void glGetBooleani_v( GLenum target, GLuint index, GLboolean *data ) {
    typedef void (*Pointer)( GLenum, GLuint, GLboolean* );
    DECLARE( "glGetBooleani_v" );
    return pointer( target, index, data );
}

void glGetIntegeri_v( GLenum target, GLuint index, GLint *data ) {
    typedef void (*Pointer)( GLenum, GLuint, GLint* );
...
GLboolean glIsEnabledi( GLenum target, GLuint index ) {
    typedef GLboolean (*Pointer)( GLenum, GLuint );
...
void glBeginConditionalRender( GLuint id, GLenum mode ) {
    typedef void (*Pointer)( GLuint, GLenum );
...
void glVertexAttribIPointer( GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *ptr ) {
    typedef void (*Pointer)( GLuint, GLint, GLenum, GLsizei, const GLvoid* );
...
void glVertexAttribI1i( GLuint index, GLint x ) {
    typedef void (*Pointer)( GLuint, GLint );
...
void glVertexAttribI3i( GLuint index, GLint x, GLint y, GLint z ) {
    typedef void (*Pointer)( GLuint, GLint, GLint, GLint );
    DECLARE( "glVertexAttribI3i" );
    return pointer( index, x, y, z );
}

void glVertexAttribI4i( GLuint index, GLint x, GLint y, GLint z, GLint w ) {
    typedef void (*Pointer)( GLuint, GLint, GLint, GLint, GLint );
...
void glVertexAttribI2ui( GLuint index, GLuint x, GLuint y ) {
    typedef void (*Pointer)( GLuint, GLuint, GLuint );
    DECLARE( "glVertexAttribI2ui" );
    return pointer( index, x, y );
}

void glVertexAttribI3ui( GLuint index, GLuint x, GLuint y, GLuint z ) {
    typedef void (*Pointer)( GLuint, GLuint, GLuint, GLuint );
    DECLARE( "glVertexAttribI3ui" );
    return pointer( index, x, y, z );
}

void glVertexAttribI4ui( GLuint index, GLuint x, GLuint y, GLuint z, GLuint w ) {
    typedef void (*Pointer)( GLuint, GLuint, GLuint, GLuint, GLuint );
...
void glGetUniformuiv( GLuint program, GLint location, GLuint *params ) {
    typedef void (*Pointer)( GLuint, GLint, GLuint* );
...
void glUniform1ui( GLint location, GLuint v0 ) {
    typedef void (*Pointer)( GLint, GLuint );
    DECLARE( "glUniform1ui" );
    return pointer( location, v0 );
}

void glUniform2ui( GLint location, GLuint v0, GLuint v1 ) {
    typedef void (*Pointer)( GLint, GLuint, GLuint );
    DECLARE( "glUniform2ui" );
    return pointer( location, v0, v1 );
}

void glUniform3ui( GLint location, GLuint v0, GLuint v1, GLuint v2 ) {
    typedef void (*Pointer)( GLint, GLuint, GLuint, GLuint );
    DECLARE( "glUniform3ui" );
    return pointer( location, v0, v1, v2 );
}

void glUniform4ui( GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3 ) {
    typedef void (*Pointer)( GLint, GLuint, GLuint, GLuint, GLuint );
    DECLARE( "glUniform4ui" );
    return pointer( location, v0, v1, v2, v3 );
}

void glUniform1uiv( GLint location, GLsizei count, const GLuint *value ) {
    typedef void (*Pointer)( GLint, GLsizei, const GLuint* );
...
void glTexParameterIuiv( GLenum target, GLenum pname, const GLuint *params ) {
    typedef void (*Pointer)( GLenum, GLenum, const GLuint* );
...
void glDrawElementsInstanced( GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount ) {
    typedef void (*Pointer)( GLenum, GLsizei, GLenum, const GLvoid*, GLsizei );
...
void glGetInteger64i_v( GLenum target, GLuint index, GLint64 *data ) {
    typedef void (*Pointer)( GLenum, GLuint, GLint64* );
    DECLARE( "glGetInteger64i_v" );
    return pointer( target, index, data );
}

void glGetBufferParameteri64v( GLenum target, GLenum pname, GLint64 *params ) {
    typedef void (*Pointer)( GLenum, GLenum, GLint64* );
...
void glFramebufferTexture( GLenum target, GLenum attachment, GLuint texture, GLint level ) {
    typedef void (*Pointer)( GLenum, GLenum, GLuint, GLint );
...
void glRenderbufferStorage( GLenum target, GLenum internalformat, GLsizei width, GLsizei height ) {
    typedef void (*Pointer)( GLenum, GLenum, GLsizei, GLsizei );
...
GLenum glCheckFramebufferStatus( GLenum target ) {
    typedef GLenum (*Pointer)( GLenum );
    DECLARE( "glCheckFramebufferStatus" );
    return pointer( target );
}

void glFramebufferTexture1D( GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level ) {
    typedef void (*Pointer)( GLenum, GLenum, GLenum, GLuint, GLint );
...
void glBlitFramebuffer( GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter ) {
    typedef void (*Pointer)( GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum );
...
void glDrawElementsInstancedBaseVertex( GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount, GLint basevertex ) {
    typedef void (*Pointer)( GLenum, GLsizei, GLenum, const GLvoid*, GLsizei, GLint );
...
void glMultiDrawElementsBaseVertex( GLenum mode, const GLsizei *count, GLenum type, const GLvoid* *indices, GLsizei primcount, const GLint *basevertex ) {
    typedef void (*Pointer)( GLenum, const GLsizei*, GLenum, const GLvoid**, GLsizei, const GLint* );
...
GLsync glFenceSync( GLenum condition, GLbitfield flags ) {
    typedef GLsync (*Pointer)( GLenum, GLbitfield );
    DECLARE( "glFenceSync" );
    return pointer( condition, flags );
}

GLboolean glIsSync( GLsync sync ) {
    typedef GLboolean (*Pointer)( GLsync );
    DECLARE( "glIsSync" );
    return pointer( sync );
}

void glDeleteSync( GLsync sync ) {
    typedef void (*Pointer)( GLsync );
    DECLARE( "glDeleteSync" );
    return pointer( sync );
}

GLenum glClientWaitSync( GLsync sync, GLbitfield flags, GLuint64 timeout ) {
    typedef GLenum (*Pointer)( GLsync, GLbitfield, GLuint64 );
    DECLARE( "glClientWaitSync" );
    return pointer( sync, flags, timeout );
}

void glWaitSync( GLsync sync, GLbitfield flags, GLuint64 timeout ) {
    typedef void (*Pointer)( GLsync, GLbitfield, GLuint64 );
    DECLARE( "glWaitSync" );
    return pointer( sync, flags, timeout );
}

void glGetInteger64v( GLenum pname, GLint64 *params ) {
    typedef void (*Pointer)( GLenum, GLint64* );
    DECLARE( "glGetInteger64v" );
    return pointer( pname, params );
}

void glGetSynciv( GLsync sync, GLenum pname, GLsizei bufSize, GLsizei *length, GLint *values ) {
    typedef void (*Pointer)( GLsync, GLenum, GLsizei, GLsizei*, GLint* );
    DECLARE( "glGetSynciv" );
    return pointer( sync, pname, bufSize, length, values );
}

void glTexImage2DMultisample( GLenum target, GLsizei samples, GLint internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations ) {
    typedef void (*Pointer)( GLenum, GLsizei, GLint, GLsizei, GLsizei, GLboolean );
...
void glTexImage3DMultisample( GLenum target, GLsizei samples, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations ) {
    typedef void (*Pointer)( GLenum, GLsizei, GLint, GLsizei, GLsizei, GLsizei, GLboolean );
...
void glGetMultisamplefv( GLenum pname, GLuint index, GLfloat *val ) {
    typedef void (*Pointer)( GLenum, GLuint, GLfloat* );
    DECLARE( "glGetMultisamplefv" );
    return pointer( pname, index, val );
}

void glSampleMaski( GLuint index, GLbitfield mask ) {
    typedef void (*Pointer)( GLuint, GLbitfield );
...
void glBlendEquationSeparatei( GLuint buf, GLenum modeRGB, GLenum modeAlpha ) {
    typedef void (*Pointer)( GLuint, GLenum, GLenum );
...
void glSamplerParameteriv( GLuint sampler, GLenum pname, const GLint *param ) {
    typedef void (*Pointer)( GLuint, GLenum, const GLint* );
...
void glSamplerParameterfv( GLuint sampler, GLenum pname, const GLfloat *param ) {
    typedef void (*Pointer)( GLuint, GLenum, const GLfloat* );
...
void glSamplerParameterIuiv( GLuint sampler, GLenum pname, const GLuint *param ) {
    typedef void (*Pointer)( GLuint, GLenum, const GLuint* );
...
void glGetQueryObjecti64v( GLuint id, GLenum pname, GLint64 *params ) {
    typedef void (*Pointer)( GLuint, GLenum, GLint64* );
    DECLARE( "glGetQueryObjecti64v" );
    return pointer( id, pname, params );
}

void glGetQueryObjectui64v( GLuint id, GLenum pname, GLuint64 *params ) {
    typedef void (*Pointer)( GLuint, GLenum, GLuint64* );
...
void glVertexP2uiv( GLenum type, const GLuint *value ) {
    typedef void (*Pointer)( GLenum, const GLuint* );
...
void glVertexAttribP1ui( GLuint index, GLenum type, GLboolean normalized, GLuint value ) {
    typedef void (*Pointer)( GLuint, GLenum, GLboolean, GLuint );
    DECLARE( "glVertexAttribP1ui" );
    return pointer( index, type, normalized, value );
}

void glVertexAttribP1uiv( GLuint index, GLenum type, GLboolean normalized, const GLuint *value ) {
    typedef void (*Pointer)( GLuint, GLenum, GLboolean, const GLuint* );
...
void glDrawArraysIndirect( GLenum mode, const GLvoid *indirect ) {
    typedef void (*Pointer)( GLenum, const GLvoid* );
    DECLARE( "glDrawArraysIndirect" );
    return pointer( mode, indirect );
}

void glDrawElementsIndirect( GLenum mode, GLenum type, const GLvoid *indirect ) {
    typedef void (*Pointer)( GLenum, GLenum, const GLvoid* );
    DECLARE( "glDrawElementsIndirect" );
    return pointer( mode, type, indirect );
}

void glUniform1d( GLint location, GLdouble x ) {
    typedef void (*Pointer)( GLint, GLdouble );
    DECLARE( "glUniform1d" );
    return pointer( location, x );
}

void glUniform2d( GLint location, GLdouble x, GLdouble y ) {
    typedef void (*Pointer)( GLint, GLdouble, GLdouble );
    DECLARE( "glUniform2d" );
    return pointer( location, x, y );
}

void glUniform3d( GLint location, GLdouble x, GLdouble y, GLdouble z ) {
    typedef void (*Pointer)( GLint, GLdouble, GLdouble, GLdouble );
    DECLARE( "glUniform3d" );
    return pointer( location, x, y, z );
}

void glUniform4d( GLint location, GLdouble x, GLdouble y, GLdouble z, GLdouble w ) {
    typedef void (*Pointer)( GLint, GLdouble, GLdouble, GLdouble, GLdouble );
    DECLARE( "glUniform4d" );
    return pointer( location, x, y, z, w );
}

void glUniform1dv( GLint location, GLsizei count, const GLdouble *value ) {
    typedef void (*Pointer)( GLint, GLsizei, const GLdouble* );
...
void glUniformMatrix2dv( GLint location, GLsizei count, GLboolean transpose, const GLdouble *value ) {
    typedef void (*Pointer)( GLint, GLsizei, GLboolean, const GLdouble* );
...
void glGetUniformdv( GLuint program, GLint location, GLdouble *params ) {
    typedef void (*Pointer)( GLuint, GLint, GLdouble* );
...
void glProgramUniformMatrix2dvEXT( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value ) {
    typedef void (*Pointer)( GLuint, GLint, GLsizei, GLboolean, const GLdouble* );
...
void glUniformSubroutinesuiv( GLenum shadertype, GLsizei count, const GLuint *indices ) {
    typedef void (*Pointer)( GLenum, GLsizei, const GLuint* );
...
void glGetProgramStageiv( GLuint program, GLenum shadertype, GLenum pname, GLint *values ) {
    typedef void (*Pointer)( GLuint, GLenum, GLenum, GLint* );
...
void glGetQueryIndexediv( GLenum target, GLuint index, GLenum pname, GLint *params ) {
    typedef void (*Pointer)( GLenum, GLuint, GLenum, GLint* );
